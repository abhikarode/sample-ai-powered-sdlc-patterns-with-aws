...
const bedrock_service_1 = require("../src/bedrock-service");
const chat_api_handler_1 = require("../src/chat-api-handler");
const conversation_service_1 = require("../src/conversation-service");
// Test configuration
...
describe('Chat API Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        bedrockService = new bedrock_service_1.BedrockService();
    });
    beforeEach(async () => {
    ...
    describe('POST /chat/ask', () => {
        test('should handle chat request with Knowledge Base integration', async () => {
            ...
            const result = await (0, chat_api_handler_1.chatApiHandler)(event, context);
    ...
    describe('GET /chat/conversations', () => {
        test('should return user conversations', async () => {
            ...
            await conversationService.addMessage(testConversationId, 'user', 'Test message');
            const event = {
                httpMethod: 'GET',
            ...
            const testConv = responseBody.conversations.find((conv) => conv.conversationId === testConversationId);
    ...
    describe('GET /chat/history/{conversationId}', () => {
        test('should return conversation history', async () => {
            ...
            await conversationService.addMessage(testConversationId, 'user', 'First message');
            await conversationService.addMessage(testConversationId, 'assistant', 'First response');
            const event = {
                httpMethod: 'GET',
    ...
    describe('DELETE /chat/conversations/{conversationId}', () => {
        test('should delete conversation successfully', async () => {
            ...
            await conversationService.addMessage(testConversationId, 'user', 'Test message for deletion');
            const event = {
                httpMethod: 'DELETE',
...
//# sourceMappingURL=chat-api-integration.test.js.map
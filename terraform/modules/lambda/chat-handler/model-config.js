...
exports.MODEL_CONFIGS = exports.CLAUDE_DIRECT_MODEL_HIERARCHY = exports.CLAUDE_INFERENCE_PROFILE_HIERARCHY = void 0;
exports.classifyQueryComplexity = classifyQueryComplexity;
exports.selectOptimalModel = selectOptimalModel;
exports.getModelConfigByName = getModelConfigByName;
const types_1 = require("./types");
// Claude inference profiles for better availability and cross-region routing
exports.CLAUDE_INFERENCE_PROFILE_HIERARCHY = [
...
exports.CLAUDE_DIRECT_MODEL_HIERARCHY = [
...
function classifyQueryComplexity(question, documentCount = 0) {
...
function selectOptimalModel(queryComplexity, requiresMultimodal = false) {
    ...
    if (queryComplexity === types_1.QueryComplexity.COMPLEX) {
        return {
...
function getModelConfigByName(modelName) {
    return exports.MODEL_CONFIGS.find(config => config.name === modelName || config.modelArn.includes(modelName));
}

...
describe('Document Management Core Integration Tests', () => {
    ...
    const createMockEvent = (method, path, pathParameters, userId = 'test-user-123', userRole = 'user') => ({
        body: null,
        headers: {},
        multiValueHeaders: {},
        httpMethod: method,
    ...
    test('should properly authenticate and authorize users', async () => {
        ...
        const unauthResult = await (0, index_1.handler)(unauthEvent, mockContext);
        ...
        const authResult = await (0, index_1.handler)(authEvent, mockContext);
    ...
    test('should handle admin vs user permissions correctly', async () => {
        ...
        const userResult = await (0, index_1.handler)(userEvent, mockContext);
        // Test admin user
        const adminEvent = createMockEvent('GET', '/documents', null, 'admin-user-123', 'admin');
        const adminResult = await (0, index_1.handler)(adminEvent, mockContext);
...
//# sourceMappingURL=document-management-core.test.js.map